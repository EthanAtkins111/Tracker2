...
export default function Opportunities() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div><h1 className="text-2xl font-bold">Sales Intelligence</h1><p className="text-muted-foreground text-sm">Top opportunities based on your account data</p></div>
      <div className="grid gap-4">
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2"><TrendingUp className="h-4 w-4 text-primary" /> Top Opportunities ({topOpps.length})</CardTitle>
        ...
        <Card>
          <CardHeader className="pb-3"><CardTitle className="text-base flex items-center gap-2"><AlertTriangle className="h-4 w-4 text-destructive" /> High Priority + Weak Relationship ({highWeakAccounts.length})</CardTitle></CardHeader>
          <CardContent className="space-y-1 max-h-80 overflow-y-auto">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2"><Bed className="h-4 w-4 text-warning" /> Large Accounts Not Visited Recently ({largeBedStale.length})</CardTitle>
